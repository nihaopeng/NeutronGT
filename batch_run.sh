...
# nohup bash run.sh origin 2 8012 ogbn-arxiv gt_sw True 5 './exps/ogbn_arxiv_max_dist_5_enc' > ogbn_arxiv_max_dist_5.log 2>&1 &
# nohup bash run.sh origin 3 8013 ogbn-arxiv gt_sw False 5 './exps/ogbn_arxiv_max_dist_5_noenc' > ogbn_arxiv_max_dist_7.log 2>&1 &
