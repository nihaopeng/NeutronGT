...
CUDA_VISIBLE_DEVICES=$2 torchrun --nproc_per_node=${device_num} --master_port $3 main_sp_node_level_ppr.py --dataset $4 --seq_len 6400 --n_layers 4 --hidden_dim 64 --ffn_dim 64 --num_heads 8 --epochs 1000 --model $5 --distributed-backend 'nccl' --attn_type 'sparse' --struct_enc $6 --max_dist $7   --use_cache 1 --ppr_backend appnp --ppr_topk 5 --ppr_alpha 0.85 --ppr_num_iterations 10 --ppr_batch_size 8192 --ppr_iter_topk 5 --distributed-timeout-minutes 120 --save_checkpoint --save_checkpoint_every 1
;;
"origin")
