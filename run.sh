...
CUDA_VISIBLE_DEVICES=$2 torchrun --nproc_per_node=${device_num} --master_port $3 main_sp_node_level_ppr.py  \
    --dataset $4 \
    --seq_len 6400 \
    ...
    --attn_type 'sparse' --reorder \
    --struct_enc $6 --max_dist $7 --vis_dir $8 \
    --use_cache 1 \
    --ppr_backend fora --fora_query_batch_size 10000 --ppr_topk 5 --ppr_alpha 0.85 \
    --fora_num_workers 4 \
    --ppr_high_degree_ratio 0.5 \
    --ppr_result_budget_gb 2 
;;
"origin")
